function registerHandler(event) {
  ...
  $.getJSON('https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyAjyk6thum-ylKNZU0QCa2ZnuS4uoNY4hM&address='+lookupaddress+'&sensor=false', null, function (data) {
  console.log(data);
  ...
  let address = data.results[0].formatted_address;
    ...
    const response = fetch("/api/properties", {
      method: "post",
      body: JSON.stringify({
        address,
        latitude,
